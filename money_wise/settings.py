"""
Django settings for money_wise project.
...
SECRET_KEY = 'django-insecure-%lr+kc*kkg8(@_)6w3r@(@qz68^2g5&t+#r2)(^c%ibm^$s(87'
...
WSGI_APPLICATION = 'money_wise.wsgi.application'
